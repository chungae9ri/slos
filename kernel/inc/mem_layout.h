...
/* kernel*/
.set KERNEL_EXCEPTION_BASE_S, 0xC0110000			
.set KERNEL_EXCEPTION_START_NS, 0xC0111000			
.set SECONDARY_EXCEPTION_START, 0xC0200000			
...
.set KERN_PGD_START_BASE_S, 			0x400000 /* page directory base, size 16KiB aligned = 1 page directory * 4KEntries * 4B size */
.set KERN_PGT_START_BASE_S, 			0x404000 /* page table base, size 4MiB = (1024 * 1024) entries * 4 */
.set KERN_PGD_START_BASE_NS, 			0x900000 /* page directory base, size 16KiB aligned = 1 page directory * 4KEntries * 4B size */
.set KERN_PGT_START_BASE_NS, 			0x904000 /* page table base, size 4MiB = (1024 * 1024) entries * 4 */
/* user app */
...
/* blank for CPU 1 normal world stack */
#define KERN_PGD_START_BASE_S 			0x400000 /* page directory base, size 16KiB aligned = 1 page directory * 4KEntries * 4B size */
#define KERN_PGT_START_BASE_S 			0x404000 /* page table base, size 4MiB = (1024 * 1024) entries * 4 */
#define KERN_PGD_START_BASE_NS 			0x900000 /* page directory base, size 16KiB aligned = 1 page directory * 4KEntries * 4B size */
#define KERN_PGT_START_BASE_NS 			0x904000 /* page table base, size 4MiB = (1024 * 1024) entries * 4 */
/* user app */
...
#define HEAP_FRAME_START ((14 MB) / (4 KB))
#define HEAP_FRAME_NUM ((1 MB) / (4 KB))
